use crate::gateway::{
    L3GatewayBackend, L3GatewayError, RealmExecutionContext, gateway_plan_fingerprint,
    validate_plan,
};
use crate::linux_fabric::gateway_execution::{LinuxGatewayCommand, SystemLinuxGatewayCommand};
use o3k_domain::{L3GatewayExecutionAttachment, L3GatewayExecutionPlan};
...
pub(crate) struct LinuxGatewayState {
...
mod tests {
    use super::*;
    use crate::gateway::{InMemoryL3GatewayBackend, L3GatewayRealizer};
