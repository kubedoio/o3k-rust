...
//!
//! This module owns SqliteStore and all its repository trait implementations.
//! Helper/utility code is at the crate root; this module imports from `crate::`.
...
fn parse_port_min(value: i64) -> Result<u16, StoreError> {
