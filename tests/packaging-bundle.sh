...
for file in \
  ...
  bootstrap-certs.sh release-gate.sh validate-human-review.sh scan-release-evidence.sh generate-candidate-evidence-manifest.py o3k-compute.service 50-o3k-libvirt.rules; do
