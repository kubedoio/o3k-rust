...
check A0-04 ! rg -q 'encode_cursor' "$native/resource.rs"
...
check A0-10 rg -q 'LIMIT|limit' "$root/crates/o3k-store/src/storage/sqlite"
check A0-11 rg -q 'LIMIT|limit' "$root/crates/o3k-store/src/storage/postgres"
