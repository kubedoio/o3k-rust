...
| Canonical L3 gateway and Realm connectivity | `docs/adr/ADR-0178-canonical-l3-gateway-and-realm-connectivity.md`, `docs/specs/SPEC-0035-canonical-l3-gateway-lifecycle-v1.md` (Accepted 2026-08-27; runtime and compatibility verification remain gated) | `docs/compatibility/p13-3/p13-3c-router-architecture-decision-request.md` |
