...
| Proposed reusable NetworkPolicy / PolicyRule / PolicyAttachment lifecycle | `docs/adr/ADR-0177-canonical-networkpolicy-and-reusable-policy-set.md`, `docs/specs/SPEC-0034-canonical-networkpolicy-lifecycle-v1.md` (Proposed 2026-08-26; not active authority and no runtime implementation authorized) | `docs/compatibility/p13-3/p13-3a-security-group-provider-contract.json` |
