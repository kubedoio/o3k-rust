...
| #49 | real-libvirt harness | merged | prerequisite validation now invokes the public OpenStack lifecycle workflow and publishes release-gate-compatible evidence; trusted-host execution pending |
