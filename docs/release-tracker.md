...
| #47 | libvirt lifecycle backend | merged | durable journal, command router, scheduler binding, canonical create builder, and durable agent-event reconciliation added; control-plane wiring and real evidence pending |
...
and ADR-0020 (durable agent-event reconciliation).
