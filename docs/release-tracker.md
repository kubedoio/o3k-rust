...
| #47 | libvirt lifecycle backend | merged | durable journal, command router, scheduler binding, and canonical create builder added; operation wiring and real evidence pending |
...
and ADR-0018 (scheduler and Placement intent), and ADR-0019 (canonical create command).
