...
| #84 | libvirt serial console and Nova console-log | repository console ownership fence and successful-delete console cleanup complete; ADR-0092/0110 and regression coverage require matching O3K domain metadata, preserve artifacts on failed deletion, and make repeated cleanup safe | blocked until actual CirrOS output, bounded restart persistence, cross-project CLI isolation, deletion evidence, and trusted real-host console artifact exist; no host acceptance claimed |
...
repeated cleanup; neither ADR substitutes for actual guest output or host
evidence.
