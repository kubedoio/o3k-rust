...
| #47 | libvirt lifecycle backend | merged | durable journal, command router, and optional scheduler binding added; runtime wiring and real evidence pending |
...
and ADR-0018 (scheduler and Placement intent).
