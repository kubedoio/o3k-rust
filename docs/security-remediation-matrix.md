...
| ASR-017 | high | Durable command/recovery | Stale accepted delete is promoted to Running and never re-observed | #575/#87 | Exact libvirtd-restart-mid-define reproduction and fresh-command safe re-drive on host | recovery, E2E, leak | Delete converges with allocation/resource cleanup; #575 linked explicitly |
